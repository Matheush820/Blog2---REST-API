...
public class ApiKeyAttribute : Attribute, IAsyncActionFilter
{
    ...
    {
        // Tenta obter a chave da query string
        ...
        // Verifica se a chave corresponde à configurada
        ...
        // Se a chave for válida, continua com a execução
        await next();
    }
}
